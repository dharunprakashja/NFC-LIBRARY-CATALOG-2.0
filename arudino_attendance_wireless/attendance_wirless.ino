...
void sendToBackend(String data)
{
    ...
    {
        // --- UPDATED FOR RENDER ---
        // Use WiFiSSLClient instead of WiFiClient for HTTPS (Port 443)
        ...
        {
            Serial.println("ERROR: Connection to backend failed! Check URL, port, and network settings.");
            return;
        }
        ...
        client.println("POST /attendance HTTP/1.1"); // Assumes your route is still /attendance
        client.println("Host: " + String(serverHost));
        client.println("Content-Type: application/json");
        client.println("Connection: close"); // Good practice to tell the server to close connection after
